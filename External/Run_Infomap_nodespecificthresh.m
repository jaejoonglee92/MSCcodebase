function Run_Infomap_nodespecificthresh(rmat, dmatname, xdistance, thresholdarray, makebinary, outdir, ignoreverts, numreps,numpools,newparpoolversion, infomapfolder)
%Run_Infomap_nodespecificthresh(rmat, dmatname, xdistance, thresholdarray, makebinary, outdir, ignoreverts, [numreps], [numpools],newparpoolversion, infomapfolder)
%
...
parfor i=1:length(thresholdarray)
    ...
    rawclrs = run_infomap_on_pajekfile(pajekfile,numreps,infomapfolder);
